...
void sevetest30_board_ctrl(board_ctrl_t *board_ctrl, board_ctrl_select_t ctrl_select)
{
    ...
    case BOARD_CTRL_AMPLIFIER:amplifier_set(board_ctrl);break;

    case BOARD_CTRL_BOOST:boost_voltage_set(board_ctrl);break;

    case BOARD_CTRL_CODEC_MODE_AND_STATUS:codechip_mode_and_status_set(board_ctrl);break;

    case BOARD_CTRL_CODEC_DAC_PIN:codec_config_dac_output(board_ctrl);break;

    case BOARD_CTRL_CODEC_DAC_VOL:codechip_volume_set(board_ctrl);break;

    case BOARD_CTRL_CODEC_ADC_PIN:codec_config_adc_input(board_ctrl);break;

    case BOARD_CTRL_CODEC_ADC_GAIN:codec_set_mic_gain(board_ctrl);break;
