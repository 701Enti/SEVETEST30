...
#define ASR_REC_TASK_CORE (0)
#define ASR_REC_TASK_PRIORITY (5)       //录制任务优先级
#define ASR_REC_TASK_STACK_SIZE (8*1024)//录制任务堆栈大小
...
#define VAD_FRAME_LENGTH 20// VAD 帧时长
...
#define BAIDU_ASR_HEADER_KEY "Content-Type"       //百度ASR HTTP-HEADER 键
#define BAIDU_ASR_HEADER_VALUE "application/json"//百度ASR HTTP-HEADER 值 
...
esp_err_t audio_element_all_init();
